...
(function() {
	...
	// Simple funcs.
	document.getElementById("kenIdle").onclick = function() {
		kenState = 0
	};
	document.getElementById("kenAttack").onclick = function() {
		kenState = 1
	};
	document.getElementById("deejayIdle").onclick = function() {
		deejayState = 0
	};
	document.getElementById("deejayAttack").onclick = function() {
		deejayState = 1
	};
